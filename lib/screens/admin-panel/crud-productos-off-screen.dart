...
class CrudProductosFlashScreen extends StatefulWidget {
  const CrudProductosFlashScreen({super.key});

  @override
  State<CrudProductosFlashScreen> createState() =>
      _CrudProductosFlashScreenState();
}

class _CrudProductosFlashScreenState extends State<CrudProductosFlashScreen> {
  @override
