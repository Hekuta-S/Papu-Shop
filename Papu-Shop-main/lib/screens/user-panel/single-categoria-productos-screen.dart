...
class SingleCategoriaProductosScreen extends StatefulWidget {
  String categoriaId;
  SingleCategoriaProductosScreen({super.key, required this.categoriaId});

  @override
  State<SingleCategoriaProductosScreen> createState() =>
      _SingleCategoriaProductosScreenState();
}

class _SingleCategoriaProductosScreenState
    extends State<SingleCategoriaProductosScreen> {
  @override
